function login() {
  return (
    <div className="relative flex flex-col items-center justify-center bg-white md:h-screen">
      <div className="p-10 bg-white rounded shadow-none md:border md:border-gray-300 md:shadow-lg">
        <div className="flex flex-col items-center space-y-3">
          ...
          <span className="text-2xl leading-normal font-semi-bold">
            Sign in
          </span>
        ...
        <form className="my-8">
          <div className="relative mb-2">
            <input
              id="email"
              className="w-full px-3 pt-5 pb-2 border border-gray-300 rounded focus:border-blue-700 focus:ring-1 focus:ring-blue-700 focus:outline-none input active:outline-none"
              type="text"
              autofocus
            />
            <label
              for="email"
              className="absolute mt-2 ml-3 text-base text-gray-600 label leading-tighter cursor-text"
            >
              Email or phone
            </label>
          </div>
          <div className="space-y-9">
            <div>
              <a className="text-sm font-bold text-blue-500" href="#">
                Forgot email?
              </a>
            </div>
            ...
            <div className="flex items-center justify-between text-sm">
              <a
                className="px-2 py-2 -ml-2 font-bold text-blue-500 rounded hover:bg-blue-50 hover:text-blue-700"
                href="#"
              >
                Create account
              </a>
              <button className="px-6 py-2 text-white bg-blue-500 rounded btn hover:bg-blue-600">
                Next
              </button>
            </div>
          </div>
